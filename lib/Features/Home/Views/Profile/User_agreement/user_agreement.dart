...
class _UserAgreementScreenState extends State<UserAgreementScreen> {
  ...
  void initState() {
    super.initState();
    controller.fetchLegalPage('terms-and-conditions');
  }
      ...
      body: Obx(() {
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () => controller.fetchLegalPage('terms-and-conditions'),
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              CustomText(
                text: controller.title.value.isNotEmpty ? controller.title.value : "🤝 User Agreement",
                fontSize: 16.sp,
